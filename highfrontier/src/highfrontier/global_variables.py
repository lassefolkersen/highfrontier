...
fullscreen = True # if the game should run in fullscreen
...
step_delay_time = 250 # how much delay (in miliseconds, I think) there should be before initiating the next iteration. This can be changed from the settings within the game
